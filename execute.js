...
let contract = new ethers.Contract('#add contract address', abi, w );

const methodName = 'execute';

const methodArguments = [0];

const iface = new ethers.utils.Interface(abi);
let dat = iface.encodeFunctionData(methodName, methodArguments)

let dat1 = contract.interface.encodeFunctionData(methodName, methodArguments)
...
const transaction = {
  ...
  async function sendTransaction() {
    ...
    try {
        const txResponse = await w.sendTransaction(transaction);
